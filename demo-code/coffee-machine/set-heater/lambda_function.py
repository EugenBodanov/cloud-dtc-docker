...
ACTION_DEFINITIONS = {
    "disableHeater": {
        "command": "OFF",
        "reason": "boiler_over_temperature",
        "required_inputs": (
            "measuredTemperature",
            "allowedTemperature",
        ),
        "left_operand": "measuredTemperature",
        "comparison": operator.gt,
        "operator_symbol": ">",
        "right_operand": "allowedTemperature",
    },
    "enableHeater": {
        "command": "ON",
        "reason": "group_head_warmup",
        "required_inputs": (
            "measuredTemperature",
            "requiredTemperature",
        ),
        ...
        "operator_symbol": "<",
        "right_operand": "requiredTemperature",
    },
}
...
def _action_definition(action_name):
    try:
        ...
        raise ValueError(
            f"unsupported heater action: {action_name}"
        ) from error
