...
ACTION_DEFINITIONS = {
    ...
    "stopStalledGrinder": {
        "command": "STOP",
        "reason": "grinder_stall",
        "required_inputs": (
            "measuredSpeed",
            "minimumSpeed",
        ),
        "left_operand": "measuredSpeed",
        "comparison": operator.lt,
        "operator_symbol": "<",
        "right_operand": "minimumSpeed",
    },
    "stopGrinderForOpenDoor": {
        "command": "STOP",
        "reason": "service_door_open",
        "required_inputs": (
            "doorState",
            "requiredState",
        ),
        "left_operand": "doorState",
        "comparison": operator.lt,
        "operator_symbol": "<",
...
def _action_definition(action_name):
    try:
        ...
        raise ValueError(
            f"unsupported grinder action: {action_name}"
        ) from error
